...
#  About this tool
This tool corrcts the refrence alleles in a VCF file.

#  Documentation
For documentation and manuals visit the [readthedocs page](http://biopet-CorrectRefAlleles.readthedocs.io/en/latest/).
